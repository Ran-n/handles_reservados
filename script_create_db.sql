CREATE TABLE IF NOT EXISTS "xenero" (
...
CREATE TABLE IF NOT EXISTS "entidade_area" (
...
CREATE TABLE IF NOT EXISTS "entidade_estado" (
    "id_entidade"   TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "entidade_lingua" (
    "id_entidade"   TEXT NOT NULL,
